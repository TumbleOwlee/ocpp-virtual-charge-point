...
> [!WARNING]
> This is a fork. Please see the original repository [solidstudiosh/ocpp-virtual-charge-point](https://github.com/solidstudiosh/ocpp-virtual-charge-point). This fork modifies the project by providing a single frontend with full control of all supported versions. You can start, stop, and switch dynamically. The changes are only generated by LLM as I'm not familiar with typescript and it's not planned to be used in any production-ready setting.
